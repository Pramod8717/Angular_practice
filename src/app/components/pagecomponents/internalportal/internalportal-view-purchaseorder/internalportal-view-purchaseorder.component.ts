...
@Component({
  selector: 'app-internalportal-view-purchaseorder',
  templateUrl: './internalportal-view-purchaseorder.component.html',
  styleUrls: ['./internalportal-view-purchaseorder.component.css']
})
export class InternalportalViewPurchaseorderComponent implements OnInit {
  productList: any;
  poDetail: any =[];
...
result:any;
  ...
  constructor(private router: Router, private route: ActivatedRoute, private activatedRoute: ActivatedRoute,private purchaseOrderListService:PurchaseOrderListService,private internalportalserviceService : InternalportalserviceService) {
